...
$(warning sw_debug: U_BOOT_VERSION =  $(U_BOOT_VERSION))
else
U_BOOT_VERSION = $(VERSION).$(PATCHLEVEL)$(EXTRAVERSION)
$(warning sw_debug: U_BOOT_VERSION =  $(U_BOOT_VERSION))
endif

$(warning sw_debug:------no------ timestamp_autogenerated.h,version_autogenerated.h---------)
TIMESTAMP_FILE = $(obj)include/timestamp_autogenerated.h
VERSION_FILE = $(obj)include/version_autogenerated.h

$(warning sw_debug: ARCH =  $(ARCH))
...
$(warning sw_debug: SHELL =  $(SHELL))
export	HOSTARCH HOSTOS SHELL
#	@echo "HOSTARCH,HOSTOS,SHELL==$(SHELL)"
...
XECHO = echo
$(warning sw_debug:have s MAKEFLAGS =  $(MAKEFLAGS))
else
XECHO = :
$(warning sw_debug:no s MAKEFLAGS =  $(MAKEFLAGS))
endif
...
BUILD_DIR := $(O)
$(warning sw_debug:----BUILD_DIR -- O =  $(O))
endif
endif

ifneq ($(BUILD_DIR),)
$(warning sw_debug: BUILD_DIR =  $(BUILD_DIR))
...
$(warning sw_debug: REMOTE_BUILD =  $(REMOTE_BUILD))
$(warning sw_debug: OBJTREE =  $(OBJTREE))
$(warning sw_debug: CURDIR =  $(CURDIR))
$(warning sw_debug: SRCTREE =  $(SRCTREE))
$(warning sw_debug: TOPDIR =  $(TOPDIR))
$(warning sw_debug: LNDIR =  $(LNDIR))
...
$(warning sw_debug: ..)
$(warning sw_debug: wildcard =  $(wildcard $(obj)include/config.mk))
$(warning sw_debug: obj config =  $(obj)include/config.mk)
...
#########################################################################
$(warning sw_debug: TOPDIR =  $(TOPDIR))
$(warning sw_debug: HOSTCC =  $(HOSTCC))
...
$(warning sw_debug: BOARDDIR =  $(BOARDDIR)!!!!!!!!!!!!!!!!!)

#@@@@@@ Add GCC lib
ifdef USE_PRIVATE_LIBGCC
$(warning sw_debug:  USE_PRIVATE_LIBGCC =  $(USE_PRIVATE_LIBGCC))
...
$(warning sw_debug: CONFIG_NAND_BOOT = $(CONFIG_NAND_BOOT))
NAND_SPL = nand_spl
...
$(ONENAND_IPL):	$(TIMESTAMP_FILE) $(VERSION_FILE) $(obj)include/autoconf.mk
		$(warning sw_debug: in ONENAND_IPL)
...
$(VERSION_FILE):
		$(warning sw_debug: in VERSION_FILE)
		@( printf '#define U_BOOT_VERSION "U-Boot %s%s"\n' "$(U_BOOT_VERSION)" \
		 '$(shell $(TOPDIR)/tools/setlocalversion $(TOPDIR))' ) > $@.tmp
		@cmp -s $@ $@.tmp && rm -f $@.tmp || mv -f $@.tmp $@
		$(warning sw_debug: out VERSION_FILE)
...
#		@echo "obj = $(obj)......@ = $@.....///subst result = $(subst $(obj),,$@)//...dir result = $(dir $(subst @(obj),,$@))"
# parallel sub-makes creating .depend files simultaneously.
$(warning sw_debug: --------depend dep--------)
$(warning sw_debug: ------SRCTREE  ==== $(SRCTREE)-------)
...
#=========}==	
	...
	@$(MKCONFIG) $(@:config_scp_1GDDR=scp_1GDDR) arm arm_cortexa9 smdkc210 samsung s5pc210 SCP_1GDDR
	@echo "@@@@@@@@@ itop_4412_android_config_scp_1GDDR  out @@@@@@@@"
#	@ >$(obj)include/config.h
...
#	@echo "U_BOOT_NAND = $(U_BOOT_NAND)"					
#	@echo "LIBBOARD = $(LIBBOARD)"					
#	@echo "BJS = $(BJS)"				
#	@#@echo "LIBS = $(LIBS)"					
#	@echo "BOARDDIR = $(BOARDDIR)"					
#	@echo "USE_PRIVATE_LIBGCC = $(USE_PRIVATE_LIBGCC)"				  
